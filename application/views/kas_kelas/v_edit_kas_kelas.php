...
<div class="container" id="table">
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center" margin-top="500px">
        <h3></br></h3>
        <h1>EDIT DATA KAS XII RPL 2</h1>
        <h2>SMK Manangga Pratama</h2>
    </div>
            <?php foreach($kas_kelas as $u){ ?>
              <div class="login-panel panel panel-default">
                <form class="form-group" role="form" action="<?php echo base_url(). 'index.php/kas_kelas/kas_kelas/update'; ?>" method="post">
                  <input type="hidden" name="id_rekap" value="<?php echo $u->id_rekap ?>">
                  <div class="form-group row">
                    <label for="total" class="col-sm-2 col-form-label">Total</label>
                    <div class="col-sm-10">
                      <input type="text" name="total" class="form-control" value="<?php echo $u->total ?>">
                    </div>
                  </div>
                  <br/>
                  <div class="form-group row">
