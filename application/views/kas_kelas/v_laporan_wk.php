  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
	  ...
	  <nav class="nav-menu d-none d-lg-block align-right">
        <ul>
            <li><a href="<?= base_url('index.php/walikelas/walikelas')?>">Beranda</a></li>
      <!-- <li><a href="#services">Tentang</a></li> -->
            <li class="active"><a href="<?= base_url('index.php/kas_kelas/laporan_walikelas')?>">Uang Kas</a></li>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center" margin-top="500px">
        <h3></br></h3>
        <h1 class="">Uang Kas Kelas XII RPL 2</h1>
        <h2 class="">Semester Ganjil</h2>
    </div>
    <div class="pricing-header mx-auto text-center" margin-top="500px">
        <h3></br></h3>
        <h2 class="">Kas Siswa</h2>
    </div>
