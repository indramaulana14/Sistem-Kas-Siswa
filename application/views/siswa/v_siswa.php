	  ...
	  <nav class="nav-menu d-none d-lg-block align-right">
        <ul>
		  ...
		  <!-- <li><a href="#services">Tentang</a></li> -->
            <li><a href="<?= base_url('index.php/kas_siswa/Tampil_siswa')?>">Kas Siswa</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <ul>
              <li><i class="bx bx-check"></i> Pastikan Anda Membayar Uang Kas</li>
              <li><i class="bx bx-check"></i> Ayo Bayar Uang Kas Tepat Waktu</li>
              <li><i class="bx bx-check"></i> Pantau Terus Uang Kas Kamu</li>
            </ul>
          <div class="mt-3">
            <a href="<?= base_url('index.php/kas_siswa/Tampil_siswa')?>" class="btn-get-started scrollto">Lihat Kas</a>
            <!-- <a href="" class="btn-get-quote">Apa Itu Kas Kelas?</a> -->
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="<?= base_url('assets/img/siswa.png') ?>" class="img-fluid" alt="">
        </div>
      </div>
    </div>
