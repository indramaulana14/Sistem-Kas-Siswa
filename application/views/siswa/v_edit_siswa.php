        ...
        <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h3 mb-0 text-gray-800"><span class="text-gray-100">-</span>Halaman Data Siswa</h1>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-secondary">Edit Data Siswa</h5>
                            </div>
                                <?php foreach($siswa as $u){ ?>
                                <div class="login-panel panel panel-default">
                                    <form class="form-group" role="form" action="<?php echo base_url(). 'index.php/siswa/data_siswa/update'; ?>" method="post">
