        ...
        <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h3 mb-0 text-gray-800"><span class="text-gray-100">-</span>Halaman Data Siswa XII RPL 2</h1>
                        </div>
                        <div class="align-items-center justify-content-between">
                            <h3 class="h4 mb-4 text-gray-800"><span class="text-gray-100">_</span>SMK Manangga Pratama</h3>
                        </div>
        <!-- Content Row -->
                <div class="row">
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-header py-3">
                                      <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modaltambah">Tambah Siswa</button>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-hover" >
                                          <thead class="bg-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-outline-primary" href="<?= base_url('index.php/siswa/data_siswa/edit/'.$u->nis) ?>">Edit</a>
                                                    ...
                                                    <div id="modalhapus-<?php echo $u->nis ?>" class="modal fade" role="dialog">
                                                      <div class="modal-dialog modal-dialog-centered">
                                                        ...
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                            <a class="btn btn-outline-primary" data-dismiss="modal">Tidak</a>
                                                            <a class="btn btn-outline-danger" href="<?= base_url('index.php/siswa/data_siswa/hapus/'.$u->nis) ?>">Ya</a>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
        ...
        <div id="modaltambah" class="modal fade" role="dialog">
          <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
              ...
              <!-- body modal -->
              <div class="modal-body">
                <form class="form-group validate-form" action="<?= base_url('index.php/siswa/data_siswa/tambah_aksi') ?>" method="post">
                  ...
                  <input type="text" class="form-control" name="password" minlength="8" required oninvalid="this.setCustomValidity('Masukan sedikitnya 8 karakter')" oninput="setCustomValidity('')">
                  <br/>
