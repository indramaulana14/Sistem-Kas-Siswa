                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-secondary">Edit Data Bendahara</h5>
                            </div>
                                <?php foreach($bendahara as $u){ ?>
            								<div class="login-panel panel panel-default">
            									<form class="form-group" role="form" action="<?php echo base_url(). 'index.php/bendahara/data_bendahara/update'; ?>" method="post">
            										<input type="hidden" class="form-control" name="id_bendahara" value="<?php echo $u->id_bendahara ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" minlength="8" name="password" value="<?php echo $u->password ?>" required oninvalid="this.setCustomValidity('Masukan sedikitnya 8 karakter')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-group validate-form" action="<?= base_url('index.php/bendahara/data_bendahara/tambah_aksi') ?>" method="post">
                  ...
                  <input type="password" class="form-control" minlength="8" name="password" required oninvalid="this.setCustomValidity('Masukan sedikitnya 8 karakter')" oninput="setCustomValidity('')">
                  <br/>
