        ...
        <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h3 mb-0 text-gray-800"><span class="text-gray-100">-</span>Halaman Data Bendahara</h1>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header py-3">
                                      <!-- <h5 class="m-0 font-weight-bold text-secondary">Data Bendahara</h5> -->
                                      <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modaltambah">Tambah Bendahara</button>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-hover" >
                                          <thead class="bg-gray-200">
                        									...
                        									<tr>
                        										...
                        										<td>
        							                <a class="btn btn-outline-primary" href="<?= base_url('index.php/bendahara/data_bendahara/edit/'.$u->id_bendahara) ?>">Edit</a>
        							                <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#modalhapus-<?php echo $u->id_bendahara ?>">Hapus</button>

                                                    <div id="modalhapus-<?php echo $u->id_bendahara ?>" class="modal fade" role="dialog">
                                                      <div class="modal-dialog modal-dialog-centered">
                                                        <!-- konten modal-->
                                                        <div class="modal-content">
                                                          <!-- heading modal -->
                                                          ...
                                                          <div class="modal-footer">
                                                            <a class="btn btn-outline-primary" data-dismiss="modal">Tidak</a>
                                                            <a class="btn btn-outline-danger" href="<?= base_url('index.php/bendahara/data_bendahara/hapus/'.$u->id_bendahara) ?>">Ya</a>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
        ...
        <div id="modaltambah" class="modal fade" role="dialog">
          <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
              <!-- heading modal -->
              <div class="modal-header">
                <h4 class="modal-title text-center">Tambah Bendahara</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
              <!-- body modal -->
              <div class="modal-body">
                <form class="form-group validate-form" action="<?= base_url('index.php/bendahara/data_bendahara/tambah_aksi') ?>" method="post">
                  <label class="label">ID Bendahara</label>
                  <input type="text" class="form-control" name="id_bendahara" required oninvalid="this.setCustomValidity('Bagian ini harus diisi')" oninput="setCustomValidity('')">
                  <br/>
